                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <th>
                                    <?php if ($r['status'] == '0') : ?>
                                        <a type="button" class="btn btn-info" href="<?php base_url('C_farhan_Masyarakat/proses_masyarakat/') . $r['id_pengaduan']  ?>">
                                            Segera
                                        </a>
                                    <?php endif ?>
                                    <?php if ($r['status'] == "proses") : ?>
                                        <a type="button" class="btn btn-warning" href="<?= base_url('C_farhan_Masyarakat/proses_masyarakat/') . $r['id_pengaduan']  ?>">
                                            Proses
                                        </a>
                                    <?php endif ?>
                                    <?php if ($r['status'] == "selesai") : ?>
                                        <a type="button" class="btn btn-success" href="<?= base_url('C_farhan_Masyarakat/proses_masyarakat/') . $r['id_pengaduan']  ?>">
                                            Selesai
                                        </a>
                                    <?php endif ?>

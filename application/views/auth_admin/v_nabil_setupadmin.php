                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-3">
                        ...
                        <div class="p-5">
                            ...
                            <form class="user" action="<?= base_url('C_farhan_auth/setup_admin') ?>" method="post"> 
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="telpon" name="telpon" placeholder="Telepon">

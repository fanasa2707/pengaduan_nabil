                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <th><a class="btn btn-danger" href="<?php echo base_url('hapus_kategori/') . $k['id_kategori'] ?> "><i class="fa fa-trash"></i></a> <a class="btn btn-warning" href="<?php echo base_url('C_farhan_admin/editKategori/') . $k['id_kategori'] ?> " data-toggle="modal" data-target="#editKategori<?= $k['id_kategori'] ?>"><i class="fa fa-edit"></i></a>
                                </th>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <th><a class="btn btn-danger" href="<?php echo base_url('C_farhan_admin/hapusSubKategori/') . $sk['id_subkategori'] ?>"><i class="fa fa-trash"></i></a> <a class="btn btn-warning" href="" data-toggle="modal" data-target="#editSubKategori<?= $sk['id_subkategori'] ?>"><i class="fa fa-edit"></i></a>
                                </th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form action="<?php echo base_url('C_farhan_admin/editKategori/' . $k["id_kategori"]) ?>" method="post">
                        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form action="<?php echo base_url('C_farhan_admin/editSubkategori/' . $sk["id_subkategori"]) ?>" method="post">
                        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
                </div>

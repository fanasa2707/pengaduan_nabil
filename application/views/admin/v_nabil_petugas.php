                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $p['telpon'] ?></td>
                                <td><?= $p['level'] ?></td>
                                <th><a class="btn btn-danger" href="<?= base_url('C_farhan_admin/hapusPetugas/') . $p['id_petugas'] ?>" onclick="return confirm('Anda takin ingin menghapus ini?')"><i class="fa fa-trash"></i></a> <a class="btn btn-warning" href="" data-toggle="modal" data-target="#editPetugas<?= $p['id_petugas'] ?>"><i class="fa fa-edit"></i></a>
                                </th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form action="<?php echo base_url('C_farhan_admin/editPetugas/' . $p["id_petugas"]) ?>" method="post">
                        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
                </div>

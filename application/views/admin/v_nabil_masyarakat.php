                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td><?= $m['telepon']  ?></td>
                                <td><?= $m['is_active']  ?></td>
                                <th><a class="btn btn-danger" href="<?= base_url('C_farhan_admin/banMasyarakat/') . $m['id'] ?>"><i class="fa fa-ban"></i></a>
                                    <a class="btn btn-success" href="<?= base_url('C_farhan_admin/aktifMasyarakat/') . $m['id'] ?>"><i class="fa fa-check"></i></a>
                                </th>
                            </tr>

                            ...
                            <tr>
                                ...
                                <th>
                                    ...
                                    <?php if ($ra['status'] == "proses") : ?>
                                        <a type="button" class="btn btn-warning" href="<?= base_url('C_farhan_petugas/proses_petugas/') . $ra['id_pengaduan'] ?>">
                                            Proses
                                        </a>
                                    <?php endif ?>
                                    <?php if ($ra['status'] == "selesai") : ?>
                                        <a type="button" class="btn btn-success" href="<?= base_url('C_farhan_petugas/selesai_petugas/') . $ra['id_pengaduan'] ?>">
                                            Selesai
                                        </a>
                                    <?php endif ?>
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form method="post" action="<?= base_url('C_farhan_admin/upload_tanggapan/') . $ra['id_pengaduan'] ?>">
                                                        <fieldset disabled>
                                                            <div class="row">

    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="container">
                ...
                <form method="post" action="<?= base_url('C_farhan_petugas/petugas_upload_tanggapan/') . $p['id_pengaduan'] ?>">
                    <fieldset disabled>
                        <div class="row">
                ...
                <div class="modal fade" id="selesai" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <form method="post" action="<?= base_url('C_farhan_petugas/petugas_update_status_selesai/') . $p['id_pengaduan'] ?> ">
    ...
    <footer class="sticky-footer bg-white">
        <div class="container my-auto">
            <div class="copyright text-center my-auto">
                <span>Copyright &copy; farhan Pengaduan 2023</span>
            </div>
        </div>
    </footer>
    <!-- End of Footer -->
